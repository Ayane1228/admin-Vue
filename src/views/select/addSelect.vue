<template>
  <div>
    ...
    <div class="addContent">
      <el-form ref="selectForm" label-width="100px" :model="selectForm" :rules="rules" class="demo-form-inline">
        <el-row>
          <el-col :span="10">
            <el-form-item label="题目" prop="newTitle">
              <el-input v-model="selectForm.newTitle" placeholder="论文题目" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="10">
            <el-form-item label="指导教师" prop="selectForm">
              <el-input v-model="selectForm.teacherName" disabled />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="5">
            <el-form-item label="教师电话" prop="selectForm">
              <el-input v-model="selectForm.teacherPhone" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="5">
            <el-form-item label="教师邮箱" prop="selectForm">
              <el-input v-model="selectForm.teacherEmail" disabled />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="5">
            <el-form-item label="教师办公室" prop="selectForm">
              <el-input v-model="selectForm.teacherOffice" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="5">
            <el-form-item label="职称" prop="selectForm">
              <el-input v-model="selectForm.teacherRank" disabled />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
